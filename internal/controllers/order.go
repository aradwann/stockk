...
func (oc *OrderController) CreateOrderOptimized(w http.ResponseWriter, r *http.Request) {
	var orderRequest orderRequest
	...
	// Create order and update ingredient stocks
	err := oc.orderService.CreateOrderOptimized(r.Context(), orderRequest.Products)
	if err != nil {
		handleServiceError(w, err)
		return
	}
